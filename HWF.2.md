...
1) Show details (ingredients and instructions) about some preconfigured recipes
2) Allow users to search for any recipe and get the results list
3) Give users the option to visit the url of the recipe

Example-

This is the home page of our website. It has some recipe options shown to the users and a search bar to search the recipes.
...
If the user searches for "pizza", then they will get these results
...
This is the page that shows the detailed view about a recipe and the ability to select particular ingredients.
